! function(e) {
    ...
    "6MkK": function(e, t, n) {
        ...
        var r = n("nSJ7"),
            ...
            a = n("V0mC"),
            l = n.n(a),
            s = { view: function() { return o()("[", null, o()(i.a, null), o()("div", { className: l.a.agreement }, o()("div", { className: l.a.title }, "梨影音用户协议"), o()("div", { className: l.a.fullText }, '在此特别提醒，若您访问和使用梨影音，请事先认真阅读本协议中各条款，包括免除或者限制责任的免责条款及对您的权利限制；\n\n如果您代表公司使用梨影音所提供服务，您在此向梨影音承诺您有权代表公司，您对本协议的接受将被自动视为您所代表的公司对本协议的接受；\n\n本协议是您与盛天娱乐(深圳)有限公司之间的协议，梨影音依据本协议为您提供服务。\n\n\n\n1.1 本协议服务条款构成您（无论是个人或者单位）使用梨影音所提供服务之先决条件。如您不同意本协议服务条款或其随时对其的修改，您应不使用或主动取消梨影音提供的服务。您的使用行为将被视为您对本协议服务条款及其随时修改版本的完全接受；\n\n1.2 这些条款可由梨影音随时更新，且毋须另行通知。修改后的服务条款一旦在梨影音上公布即取代替原来的服务条款，并构成本条款整体之一部分。您可随时登陆梨影音官网查阅最新的服务条款。\n\n1.3 当用户使用梨影音各单项服务时，对于这些服务可能有单独的服务条款加以规范，请用户在使用有关服务时另行了解和确认，用户的使用行为视为其对该单项服务的服务条款以及盛天娱乐(深圳)有限公司在该单项服务中发出的各类公告的同意。\n\n\n\n2.1 梨影音仅根据您的指令，提供信息网络存储空间及相关平台服务，本身不直接上传任何内容。您利用梨影音服务上传的内容包括但不限于音乐、动画、文字、图片、音视频作品等，您担保对利用梨影音服务上载、传播的内容负全部法律责任。\n\n2.2 您在此明确陈述并保证对所有上载、传播到梨影音上的内容，拥有或取得了所有必要的权利并承担全部的法律责任，包括但不限于：您有权或已取得必要的许可、授权、准许来使用或授权梨影音使用所有与上传作品有关的所有专利、商标、商业秘密、版权、表演者权及其他私有权利；\n\n2.3 梨影音并不担保您所有上传节目能够通过梨影音服务为其他用户所获取、浏览，梨影音没有义务和责任对所有您上载、传播的节目进行监测；但梨影音保留根据国家法律、法规的要求对上载、传播的节目进行不定时抽查的权利，并有权在不事先通知的情况下移除获断开链接违法、侵权的作品。此款的规定并不排除您对上传内容的版权担保，亦并非表明梨影音有责任及能力判断您上传作品的版权归属 。\n\n\n\n3.1 您上传的作品和内容是指您在梨影音上载、传播的视频、音频或其它任何形式的内容包括文字、图片、链接等；\n\n3.2 您在梨影音上传或发布作品的，您保证其对该等作品享有合法著作权/版权或者相应授权，并且您同意授予梨影音对所有上述作品和内容的在全球范围内的免费、不可撤销的、无限期的、并且可转让的非独家使用权许可，梨影音有权展示、散布及推广前述内容，有权对前述内容进行任何形式的复制、修改、出版、发行及以其他方式使用或者授权第三方进行复制、修改、出版、发行及以其他方式使用；\n\n3.3 梨影音在此郑重提请您注意，任何经由梨影音提供的服务以上载、张贴、发送电子邮件或任何其它方式传送的资讯、资料、文字、软件、音乐、音讯、照片、图形、视讯、信息或其它资料（以下简称“内容”），无论系公开还是私下传送，均由内容提供者、上传者承担责任，本公司不承担任何责任；\n\n3.4 梨影音无法预先知晓并合理控制经由梨影音的服务传送之内容，亦无法准确判定内容上传者的真实身份。有鉴于此，您已预知使用梨影音的服务时，可能会接触到令人不快、不适当或令人厌恶之内容，您在此同意放弃由此而产生的针对梨影音的任何追索权。但梨影音有权依法停止传输任何前述内容并采取相应行动，包括但不限于暂停您使用梨影音的服务的全部或部分，保存有关记录，并向有关机关报告；\n\n3.5 因您进行上述作品和内容在梨影音的上载、传播而导致任何第三方提出索赔要求或衍生的任何损害或损失，由您承担全部责任。\n\n为方便您使用，梨影音服务可能会提供与第三方国际互联网网站或资源进行链接。除非另有声明，梨影音无法对第三方网站服务进行控制，您因使用或依赖上述网站或资源所产生的损失或损害，梨影音不负担任何责任。\n\n\n\n4.1 您不得使用梨影音提供的服务进行任何非法、淫秽、色情及其他违反公序良俗之活动，包括但不限于非法传销、诈骗、侵权、反动行为等，梨影音有权依据自己的独立判断在不事先通知的情况下立即删除、停止从事此类活动的帐户使用；\n\n4.2 除您与梨影音另有约定外，您同意梨影音的服务仅供您个人非商业性质的使用，您不可对梨影音服务的任何部分或服务之使用或获得进行复制、拷贝、出售，或利用梨影音服务进行调查、广告或其他商业目的，但梨影音对特定服务另有适用指引或规定的除外。\n\n4.3 在盛天娱乐电子公告类服务中，用户保证对向盛天娱乐公司提供的个人作品享有著作权，用户的上载行为即意味着用户或用户代理的著作权人免费授权盛天娱乐公司对上载作品享有独家的、全球范围内不可撤销的永久的复制权、发行权、出租权、展览权、表演权、放映权、广播权、信息网络传播权、摄制权、改编权、翻译权、汇编权、使用权和收益权，而且盛天娱乐公司还可以将上述权利转让或者转授予给其他公司或个人。如用户与盛天娱乐公司另有约定的，从其约定。\n\n\n\n5.1 除您自行上载、传播的内容外，梨影音的服务中包含的任何网页、文本、图片、图形、音频和/或视频资料、商标、服务标记、公司名称、版权等，均归属梨影音所有或由梨影音经合法授权取得，受《中华人民共和国著作权法》、《中华人民共和国商标法》和/或其它财产所有权法律的保护。未经相关权利人同意，上述资料均不得在任何媒体直接或间接发布、播放、出于播放或发布目的而改写或再发行，或者被用于其他任何商业目的。上述资料或其任何部分仅可作为私人用途而保存在某台计算机内。梨影音不就由上述资料产生或在传送或递交全部或部分上述资料过程中产生的延误、不准确、错误和遗漏或从中产生或由此产生的任何损害赔偿，以任何形式向您或任何第三方负法律责任；\n\n5.2 梨影音为提供网络服务而使用的任何软件（包括但不限于软件中所含的任何图像、照片、动画、录像、录音、音乐、文字和附加程序、随附的帮助材料）的一切权利均属于该软件的著作权人，未经该软件的著作权人许可，您不得对该软件进行反向工程（reverse engineer）、反向编译（decompile）或反汇编（disassemble），或以其他方式发现其原始编码。\n\n梨影音尊重并采取合理措施保护版权人的合法利益，我们已制定了相应的版权政策与版权投诉机制，该版权政策与投诉机制均构成本协议的有机组成部分。\n\n版权政策与投诉机制详情请参考： “免责声明”\n\n5.3 但是用户在注册时选择或同意，或用户与盛天娱乐及合作单位之间就用户个人隐私信息公开或使用另有约定的除外，同时用户应自行承担因此可能产生的任何风险，盛天娱乐对此不予负责。\n\n5.4 用户同意个人隐私信息是指那些能够对用户进行个人辨识或涉及个人通信的信息，包括下列信息：用户的姓名，身份证号，手机号码，IP地址，电子邮件地址信息。而非个人隐私信息是指用户对本软件的操作状态以及使用习惯等一些明确且客观反映在盛天娱乐服务器端的基本记录信息和其他一切个人隐私信息范围外的普通信息。\n\n5.5 一般而言，盛天娱乐公司基于下列原因需要使用到用户的信息资源：(1) 执行软件验证服务。(2)执行软件升级服务。（3）网络同步服务。(4) 提高用户的使用安全性并提供客户支持。（5）因用户使用本软件特定功能或因用户要求盛天娱乐或合作单位提供特定服务时，盛天娱乐或合作单位则需要把用户的信息提供给与此相关联的第三方。（6）其他有利于用户和盛天娱乐利益的。\n\n5.6 在不透露单个用户隐私资料的前提下，盛天娱乐有权对整个用户数据库进行分析并对用户数据库进行商业上的利用。\n\n\n\n6.1 盛天娱乐公司将建立和维持一合理的程序，以保护未成年人个人资料的保密性及安全性。盛天娱乐公司郑重声明：任何18岁以下的未成年人参加网上活动应事先得到家长或其法定监护人（以下统称为"监护人"）的可经查证的同意。\n\n6.2 监护人应承担保护未成年人在网络环境下的隐私权的首要责任。\n\n6.3 未经监护人之同意，盛天娱乐公司将不会使用未成年人之个人资料，亦不会向任何第三方披露或传送可识别该未成人的个人资料，但是，由于相关法律法规要求、国家机关的查询要求、或在紧急情况下竭力维护用户个人和社会大众的隐私安全等原因除外。\n\n6.4 盛天娱乐公司收集未成年人的个人资料，这些资料只是单纯作为保护未成年人参与网络活动时的安全，而非作为其它目的之利用。盛天娱乐公司保证不会要求未成年人提供额外的个人资料，以作为允许其参与网上活动的条件。\n\n梨影音通过中华人民共和国境内的设施提供和控制服务，梨影音不担保所提供或控制之服务在其他国家或地区是适当的、可行的，任何在其他司法管辖区使用梨影音服务的您应自行确保遵守当地的法律、法规，梨影音对此不负任何责任。\n\n\n\n7.1 您同意梨影音有权基于其自行之考虑，因任何理由，包括但不限于缺乏使用或梨影音认为您已经违反本协议的文字及精神，而终止您的帐号或服务之全部或任何部分，并将您在梨影音的服务内的任何内容加以移除并删除；\n\n7.2 您同意依本协议任何规定提供之服务，无需进行事先通知即可中断或终止，您承认并同意，梨影音可立即关闭或删除您的帐号及您帐号中所有相关信息及文件，及/或禁止继续使用前述文件或梨影音的服务。\n\n此外，您同意若梨影音的服务之使用被中断、终止或您的帐号及相关信息和文件被关闭、删除，梨影音对您或任何第三人均不承担任何责任。\n\n\n\n8.1 本协议的生效、履行、解释及争议的解决均适用中华人民共和国法律；\n\n8.2 如就本协议内容或其执行发生任何争议，应尽量友好协商解决；协商不成时，则争议各方均可向盛天娱乐公司注册所在地，具有管辖权的人民法院提起诉讼。\n\n8.3 本《协议》的一切解释权与修改权归盛天娱乐。'))) } };
        n("p2bk"), n("VLLQ");
